<?php 
	...
	$titulo='Registrar Usuario';			$existe=FALSE;	$boton='Registrar';		$deposito='';
            ...
            <td>
            	<?php
					...
					if(!empty($_POST['doc']) and !empty($_POST['nom'])){
							...
							$oAlumno=new Proceso_Usuario($doc,$nom,$ape,$fecha,$tel,$cel,$sexo,$dir,$nota,$fechar,$estado,$correo,$con,$tipo,$deposito);
